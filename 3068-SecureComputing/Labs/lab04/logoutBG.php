...
// If we're using cookies, also delete the session cookie
...
<head>
  ...
  <style>
    ...
    a.button { display: inline-block; padding: 0.6rem 0.8rem; background: #1a73e8; color: #fff; border-radius: 10px; text-decoration: none; }
  </style>
</head>
<body>
  <div class="card">
